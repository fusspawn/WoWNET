...
namespace Wrapper.API
{
    ...
    {
        /// <summary>
        ///   @CSharpLua.Template = "LibJSON.Serialize({0})"
        /// </summary>
        public static extern string Serialize(object Object);


        /// <summary>
        ///   @CSharpLua.Template = "LibJSON.Deserialize({0})"
        /// </summary>
        public static extern T Deserialize<T>(string Object);
