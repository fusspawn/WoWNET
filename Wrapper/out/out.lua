...
local System = System
local WrapperAPI
local WrapperAPILuaBox
System.import(function (out)
  WrapperAPI = Wrapper.API
  WrapperAPILuaBox = Wrapper.API.LuaBox
end)
  ...
  namespace.class("Program", function (namespace)
    ...
    Main = function (args)
      ...
      for _, GUID in System.each(objects) do
        System.Console.WriteLine("Found GUID: " .. System.toString(GUID) .. ", Type: " .. System.EnumToString(__LB__.ObjectType(GUID), WrapperAPILuaBox.EObjectType))
        System.Console.WriteLine("Name: " .. System.toString( __LB__.ObjectName(GUID)))
      end
    end
    return {
      Main = Main
