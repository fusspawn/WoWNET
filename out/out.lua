...
System.namespace("Wrapper", function (namespace)
  ...
  namespace.class("DataLoggerBase", function (namespace)
    ...
    __ctor__ = function (this)
      this.SmartGrind = WrapperBotBases.NativeGrindBotBase()
    ...
    Pulse = function (this)
      ...
      if class.UIData == nil then
        ...
        class.UIData.BotBaseSelector = _StdUI:Dropdown(class.UIData.MainUIFrame, 150, 25, Options, 2, false, false)

        class.UIData.BotBaseSelector:SetOptions(Options)
        class.UIData.BotBaseSelector:SetPlaceholder("~-- Please Select a BotBase --~")
    ...
    HandleHunterLogic = function (this)
      ...
      if not WrapperWoW.ObjectManager.getInstance().Player:getIsChanneling() and not WrapperWoW.ObjectManager.getInstance().Player:getIsCasting() then
        ...
        if GetTime() - this.CastTimeStamp > 5 then
...
System.namespace("Wrapper.API", function (namespace)
  ...
  namespace.class("Navigator", function (namespace)
    local MoveTo
    MoveTo = function (this, x, y, z, index, proximityTolerance)
...
System.namespace("Wrapper", function (namespace)
  namespace.class("StdUI", function (namespace)
    ...
    namespace.class("StdUiScrollTable", function (namespace)
      namespace.class("StdUiScrollTableColumnDefinition", function (namespace)
        return {
          width = 0,
          sortable = false
        }
      end)
      namespace.class("StdUiScrollTableColumnColor", function (namespace)
        return {
          r = 0,
          g = 0,
          b = 0,
    ...
    namespace.class("StdUiDropdown", function (namespace)
      namespace.class("StdUiDropdownItems", function (namespace)
        return {}
      end)
      return {
        base = function (out)
    ...
    RunBattleGroundLogic = function (this)
      ...
      if BestTarget ~= nil then
        ...
        if (WrapperWoW.Vector3.Distance(WrapperWoW.ObjectManager.getInstance().Player.Position, BestTarget.Position) > 25 or not BestTarget.LineOfSight) and not (WrapperWoW.ObjectManager.getInstance().Player:getIsCasting() or WrapperWoW.ObjectManager.getInstance().Player:getIsChanneling()) then
          __LB__.Navigator.AllowMounting(false)
          WrapperAPI.LuaBox.getInstance().Navigator:MoveTo(BestTarget.Position.X, BestTarget.Position.Y, BestTarget.Position.Z, 1, 15)
          return
        else
          __LB__.Navigator.Stop()
        end
...
System.namespace("Wrapper.BotBases", function (namespace)
  namespace.class("NativeGrindBotBase", function (namespace)
    ...
    BuildConfig = function (this, Container)
      ...
      UIContainer = class.NativeGrindUIContainer()
      UIContainer.Container = Wrapper.Program.MainUI.StdUI:Frame(Container, Container:GetWidth(), Container:GetHeight() - 150)
      Wrapper.Program.MainUI.StdUI:GlueTop(UIContainer.Container, Container, 0, - 100, "TOP")

      UIContainer.GrindLabel = Wrapper.Program.MainUI.StdUI:Label(UIContainer.Container, "~== Native Grind Config ==~", 18, nil, Container:GetWidth() - 10, 25)
      Wrapper.Program.MainUI.StdUI:GlueTop(UIContainer.GrindLabel, UIContainer.Container, 50, 0, "TOP")
    ...
    DrawDebug = function (this)
      ...
      class.StateMachine:DebugRender()
...
System.namespace("Wrapper.Database", function (namespace)
  namespace.class("WoWDatabase", function (namespace)
    local DirtyMapIds, IsSaveTaskRunning, getHasDirtyMaps, GetGridHash, InsertDeathSpotIfRequired, InsertNpcIfRequired, IsConsideredDeathSpot, HandlePersistance, 
    InsertNodeIfRequired, EnsureSaveProcessIsRunning, GetMapDatabase, GetClosestRepairNPC, GetClosestVendorNPC, GetAllHerbLocations, GetAllOreLocations, class, 
    static
    static = function (this)
    ...
    InsertDeathSpotIfRequired = function (Position)
      local MapId =  __LB__.GetMapId()
      local IsDirty = false
      local MapDatabase = GetMapDatabase(MapId)


      if not Linq.Any(MapDatabase.PlayerDeathSpots, function (x)
        return WrapperWoW.Vector3.Distance(Position:__clone__(), WrapperWoW.Vector3(x.X, x.Y, x.Z)) < class.GRID_SIZE
      end) then
        MapDatabase.PlayerDeathSpots:Add(Position:__clone__())
        IsDirty = true
      end
    ...
    IsConsideredDeathSpot = function (x, y, z)
      local CheckPos = WrapperWoW.Vector3(x, y, z)
      local MapId =  __LB__.GetMapId()
      local Data = GetMapDatabase(MapId)

      return Linq.Any(Data.PlayerDeathSpots, function (x)
        return WrapperWoW.Vector3.Distance(x:__clone__(), CheckPos:__clone__()) < class.GRID_SIZE
      end)
    end
    ...
    class = {
      ...
      InsertDeathSpotIfRequired = InsertDeathSpotIfRequired,
      InsertNpcIfRequired = InsertNpcIfRequired,
      IsConsideredDeathSpot = IsConsideredDeathSpot,
...
do
local System = System
local DictStringDouble = System.Dictionary(System.String, System.Double)
local Wrapper
System.import(function (out)
  Wrapper = out.Wrapper
end)
System.namespace("Wrapper.Helpers", function (namespace)
  namespace.class("Blacklist", function (namespace)
    local IsOnBlackList, AddToBlacklist, class, static
    static = function (this)
      this.BlackListEntrys = DictStringDouble()
    end
    IsOnBlackList = function (GUID)
      if not class.BlackListEntrys:ContainsKey(GUID) then
        return false
      end

      if class.BlackListEntrys:get(GUID) > Wrapper.Program.CurrentTime then
        return true
      end

      class.BlackListEntrys:RemoveKey(GUID)
      return false
    end
    AddToBlacklist = function (GUID, NumSeconds)
      class.BlackListEntrys:set(GUID, Wrapper.Program.CurrentTime + NumSeconds)
    end
    class = {
...
System.namespace("Wrapper.NativeBehaviors", function (namespace)
  namespace.class("NativeGrindBaseState", function (namespace)
    local Complete, Tick, class, static
    static = function (this)
    ...
    Tick = function (this)
      if __LB__.UnitTagHandler(UnitIsDeadOrGhost, "player") and (System.ObjectGetType(WrapperBotBases.NativeGrindBotBase.StateMachine.States:Peek()):getName() ~= System.typeof(WrapperNativeGrindTasks.NativeGrindCorpseRunTask):getName()) then
        WrapperBotBases.NativeGrindBotBase.StateMachine.States:Push(WrapperNativeGrindTasks.NativeGrindCorpseRunTask())
        return
      end


      if WrapperWoW.ObjectManager.getInstance().Player:GetDurability() < 30 and (System.ObjectGetType(WrapperBotBases.NativeGrindBotBase.StateMachine.States:Peek()):getName() ~= System.typeof(WrapperNativeGrindTasks.NativeGrindRepairTask):getName()) then
        WrapperBotBases.NativeGrindBotBase.StateMachine.States:Push(WrapperNativeGrindTasks.NativeGrindRepairTask())
        return
      end
      ...
      if NextObjective ~= nil then
        repeat
          ...
          if default == 1 --[[SmartObjectiveTaskType.Gather]] then
            WrapperBotBases.NativeGrindBotBase.StateMachine.States:Push(WrapperNativeGrindTasks.NativeGrindGatherTask(NextObjective))
            break
          elseif default == 2 --[[SmartObjectiveTaskType.Loot]] then
            WrapperBotBases.NativeGrindBotBase.StateMachine.States:Push(WrapperNativeGrindTasks.NativeGrindLootTask(NextObjective))
            break
          elseif default == 0 --[[SmartObjectiveTaskType.Kill]] then
            WrapperBotBases.NativeGrindBotBase.StateMachine.States:Push(WrapperNativeGrindTasks.NativeGrindKillTask(NextObjective))
            break
          end
        until 1
      ...
      for _, Unit in System.each(Linq.Where(this.Units:GetUnits(), function (x)
        ...
        repeat
          ...
          if Linq.Any(this.Players:GetUnits(), function (x)
            ...
            score = score - 200
            -- Was to close to another player. Move away
          end
...
System.namespace("Wrapper.UI", function (namespace)
  namespace.class("BotMainUI", function (namespace)
    local SetConfigPanel, CreateMainFrame, class, __ctor__
    namespace.class("BotUIDataContainer", function (namespace)
      return {}
    end)
    __ctor__ = function (this)
    ...
    SetConfigPanel = function (this, Frame)
      if this.UIContainer.ConfigFrame ~= nil then
        this.UIContainer.ConfigFrame:Hide()
      end

      this.UIContainer.ConfigFrame = Frame

      if Frame ~= nil then
        Frame:Show()
      end
    end
    CreateMainFrame = function (this)
      if this.StdUI == nil then
        this.StdUI = LibStub("StdUi"):NewInstance()
      end

      this.UIContainer = class.BotUIDataContainer()
      this.UIContainer.MainBotUIFrame = this.StdUI:Window(_G["UIParent"], 500, 600, "BroBot")
      this.UIContainer.MainBotUIFrame:SetPoint("CENTER", 0, 0)
      this.UIContainer.MainBotUIFrame:Show()
      ...
      this.UIContainer.SelectedBotBase = this.StdUI:Dropdown(this.UIContainer.MainBotUIFrame, 200, 25, Options, nil, false, false)

      this.UIContainer.SelectedBotBase:SetOptions(Options)
      this.UIContainer.SelectedBotBase:SetPlaceholder("~-- Please Select a BotBase --~")
      this.UIContainer.SelectedBotBase.OnValueChanged = System.DelegateCombine(this.UIContainer.SelectedBotBase.OnValueChanged, function (self, values)
        ...
        if Wrapper.Program.Base ~= nil then
          Wrapper.Program.Base:BuildConfig(this.UIContainer.MainBotUIFrame)
        end
      end)

      this.StdUI:GlueTop(this.UIContainer.SelectedBotBase, this.UIContainer.MainBotUIFrame, 0, - 40, "TOP")


      this.UIContainer.ToggleBotUI = this.StdUI:HighlightButton(_G["UIParent"], 100, 25, "Toggle BroBot UI")
      this.UIContainer.ToggleBotUI:SetScript("OnClick", function ()
        if not this.UIContainer.MainBotUIFrame:IsShown() then
          this.UIContainer.MainBotUIFrame:Show()
        else
          this.UIContainer.MainBotUIFrame:Hide()
        end
      end, System.Delegate)
...
System.namespace("Wrapper.UI", function (namespace)
  namespace.class("SlashCommands", function (namespace)
    ...
    RegisterSlashCommand = function (command, Function)
...
local Linq = System.Linq.Enumerable
local Wrapper
local WrapperStdUiScrollTable
local WrapperWoW
local ListStdUiScrollTableColumnDefinition
System.import(function (out)
  Wrapper = out.Wrapper
  WrapperStdUiScrollTable = Wrapper.StdUI.StdUiScrollTable
  WrapperWoW = Wrapper.WoW
  ListStdUiScrollTableColumnDefinition = System.List(WrapperStdUiScrollTable.StdUiScrollTableColumnDefinition)
end)
System.namespace("Wrapper.UI", function (namespace)
...
System.namespace("Wrapper.WoW", function (namespace)
  namespace.class("LocalPlayer", function (namespace)
    local getPet, CreateCombatTrackingFrame, Update, HasRequiredSkillToHarvest, HasProfession, GetDurability, FaceUnit, FindPet, 
    __ctor__
    __ctor__ = function (this)
      System.base(this).__ctor__(this, "player")
      CreateCombatTrackingFrame(this)
    end
    getPet = function (this)
      return FindPet(this)
    end
    CreateCombatTrackingFrame = function (this)
      this.CombatTrackingFrame = CreateFrame("Frame", nil, nil, nil)
      this.CombatTrackingFrame:RegisterEvent("PLAYER_REGEN_DISABLED")
      this.CombatTrackingFrame:RegisterEvent("PLAYER_REGEN_ENABLED")
      this.CombatTrackingFrame:RegisterEvent("PLAYER_DEAD")
    ...
    FaceUnit = function (this, targetUnitOrObject)
      local PlayerPos = WrapperWoW.ObjectManager.getInstance().Player.Position:__clone__()
      local ObjectPos = targetUnitOrObject.Position:__clone__()
...
System.namespace("Wrapper.WoW", function (namespace)
  namespace.class("ObjectManager", function (namespace)
    ...
    FindNPCByObjectID = function (ObjectID)
      return System.as(Linq.FirstOrDefault(Linq.OrderBy(Linq.Where(getInstance().AllObjects:getValues(), function (x)
        return x.ObjectType == 5 --[[EObjectType.Unit]] and x.ObjectId == ObjectID
      end), function (x)
        return x:DistanceToPlayer()
      end, nil, System.Double)), WrapperWoW.WoWUnit)
    end
    class = {
      getInstance = getInstance,
...
System.namespace("Wrapper.WoW", function (namespace)
  namespace.class("WoWUnit", function (namespace)
    local getFriend, getHostile, getNeutral, getAttackable, getIsCasting, getIsChanneling, getIsTargettingMeOrPet, Interact, 
    Update, UnitIsFlying, Target, __ctor__
    __ctor__ = function (this, _GUID)
    ...
    return {
      ...
      IsBossOrElite = false,
      getIsTargettingMeOrPet = getIsTargettingMeOrPet,
      Interact = Interact,
      Update = Update,
...
System.namespace("Wrapper.NativeBehaviors.BehaviorStateMachine", function (namespace)
  namespace.class("StateMachine", function (namespace)
    local Run, DebugRender, __ctor__
    __ctor__ = function (this)
    ...
    Run = function (this)
      if #this.States > 0 then
        ...
        if Wrapper.Program.Tracker ~= nil and Wrapper.Program.Tracker.TaskLabel ~= nil then
...
System.namespace("Wrapper.NativeBehaviors.BehaviorStateMachine", function (namespace)
  namespace.class("StateMachineState", function (namespace)
    local ResetMaxStateTime, IsOutOfTime, StringRepr, DebugDump, SetMaxStateTime, Complete, Tick, DebugRender
    ResetMaxStateTime = function (this)
      this.EntryTime = Wrapper.Program.CurrentTime
    end
    ...
    DebugDump = function (this)
      return DictStringObject()
    end
  ...
  namespace.class("NativeGrindCorpseRunTask", function (namespace)
    ...
    Tick = function (this)
      ...
      if WrapperWoW.Vector3.Distance(WrapperWoW.ObjectManager.getInstance().Player.Position, CorpsePos:__clone__()) > 28 then
        WrapperAPI.LuaBox.getInstance().Navigator:MoveTo(CorpsePos.X, CorpsePos.Y, CorpsePos.Z, 1, 1)
        return
      end
  ...
  namespace.class("NativeGrindGatherTask", function (namespace)
    ...
    Tick = function (this)
      ...
      if Distance > 5 then
        ...
        WrapperAPI.LuaBox.getInstance().Navigator:MoveTo(this.Task.TargetUnitOrObject.Position.X, this.Task.TargetUnitOrObject.Position.Y, this.Task.TargetUnitOrObject.Position.Z, 1, 4)
        return
      end
  ...
  namespace.class("NativeGrindKillTask", function (namespace)
    ...
    Tick = function (this)
      ...
      if Distance > CombatRange or not (System.as(this.Task.TargetUnitOrObject, WrapperWoW.WoWUnit)).LineOfSight then
        ...
        WrapperAPI.LuaBox.getInstance().Navigator:MoveTo(this.Task.TargetUnitOrObject.Position.X, this.Task.TargetUnitOrObject.Position.Y, this.Task.TargetUnitOrObject.Position.Z, 1, CombatRange - 1)
        ...
        if Wrapper.Program.CurrentTime - this.LastFaceDirection > 1 then
          WrapperAPI.DebugLog.Log("Combat", "Facing Unit", false)
          this.LastFaceDirection = Wrapper.Program.CurrentTime
          --WoWAPI.InteractUnit(Task.TargetUnitOrObject.GUID);
          WrapperWoW.ObjectManager.getInstance().Player:FaceUnit(this.Task.TargetUnitOrObject)
        end
      end
...
System.namespace("Wrapper.NativeBehaviors.NativeGrindTasks", function (namespace)
  namespace.class("NativeGrindLootTask", function (namespace)
    ...
    Complete = function (this)
      ...
      return (not  __LB__.ObjectExists(this.Task.TargetUnitOrObject.GUID) or this.HasLooted or WrapperWoW.ObjectManager.getInstance().Player.IsInCombat or this:IsOutOfTime())
    end
    Tick = function (this)
      local Distance = WrapperWoW.Vector3.Distance(this.Task.TargetUnitOrObject.Position, WrapperWoW.ObjectManager.getInstance().Player.Position)
...
System.namespace("Wrapper.NativeBehaviors.NativeGrindTasks", function (namespace)
  namespace.class("NativeGrindRepairTask", function (namespace)
    local Complete, Tick
    Complete = function (this)
      return this.HasRepaired or __LB__.UnitTagHandler(UnitIsDeadOrGhost, "player")
    end
    Tick = function (this)
      ...
      if WrapperWoW.Vector3.Distance(WrapperWoW.ObjectManager.getInstance().Player.Position, NPCPosition:__clone__()) > 5 then
        WrapperAPI.LuaBox.getInstance().Navigator:MoveTo(NPC.X, NPC.Y, NPC.Z, 1, 4)
      ...
      if _G["MerchantRepairAllButton"] ~= nil and _G["MerchantRepairAllButton"]:IsShown() then
...
System.namespace("Wrapper.NativeBehaviors.NativeGrindTasks", function (namespace)
  namespace.class("NativeGrindSearchForNode", function (namespace)
    local DebugRender, Complete, Tick, __ctor__
    ...
    Complete = function (this)
      ...
      local IsInCombat = WrapperWoW.ObjectManager.getInstance().Player.IsInCombat
      local NextTask = this.ObjectiveScanner:GetNextTask(true)


      if WrapperWoW.ObjectManager.getInstance().Player.IsInCombat then
        WrapperAPI.DebugLog.Log("SearchForNode", "Switching to Combat?!", false)
        return true
      end
      if NextTask ~= nil then
        WrapperAPI.DebugLog.Log("SearchForNode", "Next Task Is: " .. System.EnumToString(NextTask.TaskType, NativeGrindSmartObjective.SmartObjectiveTaskType), false)
        return true
      end
    ...
    Tick = function (this)
      ...
      if this.TargetNode == nil then
        ...
        if #AllNodes > 0 then
          ...
          if not IsReachable then
            WrapperAPI.DebugLog.Log("SearchForNode", "Intended Destination wasnt reachable reject it", false)
            return
          end
          ...
          WrapperAPI.DebugLog.Log("SearchForNode", "Unable to find a valid node in the database? Has the map been scanned?!", false)
          return
        end
      end

      this._StringRepr = "Moving To TargetNode"
      WrapperAPI.LuaBox.getInstance().Navigator:MoveTo(this.TargetNode.X, this.TargetNode.Y, this.TargetNode.Z, 1, 1)
      ...
      if WrapperWoW.Vector3.Distance(WrapperWoW.Vector3(this.TargetNode.X, this.TargetNode.Y, this.TargetNode.Z), WrapperWoW.ObjectManager.getInstance().Player.Position) < 10 then
        WrapperAPI.DebugLog.Log("SearchForNode", "Got to target node with nothing to do. Lets give this one up and grab another", false)
        this.TargetNode = nil
      end
...
System.namespace("Wrapper.WoW.Filters", function (namespace)
  namespace.class("DeadUnitsFilterList", function (namespace)
    ...
    __ctor__ = function (this)
      ...
      WrapperWoW.ObjectManager.getInstance().OnRemoveObject = System.DelegateCombine(WrapperWoW.ObjectManager.getInstance().OnRemoveObject, function (gameObject)
        if this.FilteredUnits:ContainsKey(gameObject.GUID) then
          WrapperAPI.DebugLog.Log("DeadUnitFilter", "Removing Dead Unit: " .. System.toString(gameObject.Name), false)
    ...
    CreateEventTrackingFrame = function (this)
      ...
      this.EventFrame:SetScript("OnEvent", function (timeStamp, subevent, hideCaster, sourceGUID, sourceName, sourceFlags, sourceRaidFlags, destGUID, destName, destFlags, destRaidFlags)
        ...
        if not DestExists then
          WrapperAPI.DebugLog.Log("DeadUnitFilter", "Was given a dead event guid for an unknown unit", false)
          return
        end

        WrapperAPI.DebugLog.Log("DeadUnitFilter", "Found Dead Unit: " .. System.toString(WrapperWoW.ObjectManager.getInstance().AllObjects:get(destGUID).Name), false)
    ...
    ScanObjectManager = function (this)
      for _, Unit in System.each(Linq.Where(WrapperWoW.ObjectManager.getInstance().AllObjects, function (x)
        return x.Value.ObjectType == 5 --[[EObjectType.Unit]] and __LB__.UnitTagHandler(UnitIsDead, x.Value.GUID)
      end)) do
        this.FilteredUnits:AddKeyValue(Unit.Value.GUID, System.cast(WrapperWoW.WoWUnit, Unit.Value))
      end
    end
    return {
      base = function (out)
...
System.namespace("Wrapper.WoW.Filters", function (namespace)
  namespace.class("GatheringNodeFilterList", function (namespace)
    ...
    __ctor__ = function (this, OnlyViableProfessions)
      ...
      WrapperAPI.DebugLog.Log("GatheringNodeFilter", "Gathering Node filter created with only Professions: " .. System.toString(OnlyViableProfessions), false)
    end
    FilterGameObject = function (this, GameObject)
      local IsHerbOrOre = (GameObject:getIsHerb() or GameObject:getIsOre())
      if not IsHerbOrOre then
        return false
      end

      if not this.RequireProfessions then
        System.Console.WriteLine("Require Professions Was False")
        return true
      end

      local HasProfession = WrapperWoW.ObjectManager.getInstance().Player:HasRequiredSkillToHarvest(GameObject)
      if HasProfession then
        WrapperAPI.DebugLog.Log("GatheringNodeFilter", "Found Filter with Profession: " .. System.toString(GameObject.Name) .. " Herb: " .. System.toString(GameObject:getIsHerb()) .. " Ore " .. System.toString(GameObject:getIsOre()), false)
      end
...
System.namespace("Wrapper.WoW.Filters", function (namespace)
  namespace.class("PlayerFilterList", function (namespace)
    ...
    FilterUnit = function (this, GameObject)
      ...
      if Result then
        WrapperAPI.DebugLog.Log("PlayerFilterList", "Found Player " .. System.toString(GameObject.Name), false)
      end

      if Result and this.AllowFriendly and GameObject:getFriend() then
        WrapperAPI.DebugLog.Log("PlayerFilterList", "Found Player F", false)
        return true
      end

      if Result and this.AllowHostile and GameObject:getHostile() then
        WrapperAPI.DebugLog.Log("PlayerFilterList", "Found Player H", false)
        return true
      end
...
System.namespace("Wrapper.WoW.Filters", function (namespace)
  namespace.class("UnitFilterList", function (namespace)
    ...
    FilterUnit = function (this, GameObject)
      if GameObject.ObjectType == 6 --[[EObjectType.Player]] then
        return false
      end
...
System.init({
  types = {
    ...
    "Wrapper.StdUI.StdUiScrollTable",
    "Wrapper.UI.BotMainUI",
    "Wrapper.UI.NativeErrorLoggerUI",
    "Wrapper.UI.UnitViewer",
    ...
    "Wrapper.NativeBehaviors.NativeGrindTasks.NativeGrindRepairTask",
    "Wrapper.NativeBehaviors.NativeGrindTasks.NativeGrindSearchForNode",
    "Wrapper.Program",
    "Wrapper.StdUI.StdUiButton",
    "Wrapper.StdUI.StdUiCheckBox",
    "Wrapper.StdUI.StdUiDropdown.StdUiDropdownItems",
    "Wrapper.StdUI.StdUiLabel",
    "Wrapper.StdUI.StdUiNumericInputFrame",
    "Wrapper.StdUI.StdUiScrollTable.StdUiScrollTableColumnColor",
    "Wrapper.StdUI.StdUiScrollTable.StdUiScrollTableColumnDefinition",
    "Wrapper.UI.BotMainUI.BotUIDataContainer",
    "Wrapper.UI.NativeErrorLoggerUI.ErrorMessageData",
    "Wrapper.UI.SlashCommands",
    "Wrapper.UI.Tracker",
    "Wrapper.UI.UnitViewer.UnitViewerUIContainer",
