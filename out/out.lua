...
System.import(function (out)
  WrapperObjectManager = Wrapper.ObjectManager
end)
...
System.namespace("Wrapper.API", function (namespace)
  namespace.class("LuaBox", function (namespace)
    ...
    ObjectPositionVector3 = function (this, GUIDorUnitID)
      ...
      return WrapperObjectManager.Vector3(x, y, z)
    end
    class = {
...
local System = System
System.namespace("Wrapper.API", function (namespace)
  namespace.class("WoW", function (namespace)
    return {}
  end)
end)
...
System.namespace("Wrapper.ObjectManager", function (namespace)
  namespace.class("WoWGameObject", function (namespace)
    ...
    __ctor__ = function (this, _GUID)
      this.Position = System.default(WrapperObjectManager.Vector3)
      this.GUID = _GUID
...
System.import(function (out)
  WrapperObjectManager = Wrapper.ObjectManager
  DictStringWoWGameObject = System.Dictionary(System.String, WrapperObjectManager.WoWGameObject)
end)
System.namespace("Wrapper.ObjectManager", function (namespace)
    ...
    CreateWowObject = function (this, GUID)
      repeat
        ...
        if default == 6 --[[EObjectType.Player]] then
          return WrapperObjectManager.WoWPlayer(GUID)
        elseif default == 5 --[[EObjectType.Unit]] then
          return WrapperObjectManager.WoWUnit(GUID)
        else
          return WrapperObjectManager.WoWGameObject(GUID)
        end
      until 1
    end
...
System.namespace("Wrapper.ObjectManager", function (namespace)
  namespace.class("WoWPlayer", function (namespace)
    ...
    return {
      base = function (out)
        return {
          out.Wrapper.ObjectManager.WoWGameObject
        }
      end,
      Health = 0,
      HealthMax = 0,
...
System.namespace("Wrapper.ObjectManager", function (namespace)
  namespace.struct("Vector3", function (namespace)
    ...
    ToString = function (this)
      local sb = System.StringBuilder(32)
      sb:Append("{X:")
      sb:Append(this.X)
      sb:Append(" Y:")
      sb:Append(this.Y)
    ...
    class = {
      base = function (out)
        return {
          System.IEquatable_1(out.Wrapper.ObjectManager.Vector3)
        }
      end,
      X = 0,
      Y = 0,
...
System.init({
  types = {
    "Wrapper.API.LuaBox",
    "Wrapper.ObjectManager.WoWGameObject",
    ...
    "Wrapper.API.WoW",
    "Wrapper.ObjectManager.ObjectManager",
    "Wrapper.ObjectManager.Vector3",
    "Wrapper.ObjectManager.WoWPlayer",
    "Wrapper.ObjectManager.WoWUnit",
    "Wrapper.Program"
  }
})
